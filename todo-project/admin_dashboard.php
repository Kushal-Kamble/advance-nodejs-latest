...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css">
   <link rel="icon" type="image/png" href="images/favicon-mit.ico" />
          ...
          <tbody>
            ...
            <?php while ($task = mysqli_fetch_assoc($taskResult)) { ?>
              <tr>
                ...
                <td>
                  <span class="badge 
    <?= $task['priority'] == 'Low' ? 'bg-success' : ($task['priority'] == 'Medium' ? 'bg-warning text-dark' : ($task['priority'] == 'High' ? 'bg-danger' : 'bg-secondary')) ?>">
